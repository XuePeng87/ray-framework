...
import cc.xuepeng.ray.framework.module.common.log.enums.SysAuthLogType;
...
public class LogoutLogAspect {
     ...
     * 对注解修饰的方法进行切面处理
     */
    @Pointcut(value = "@annotation(cc.xuepeng.ray.framework.module.common.log.annotation.LogoutLog)")
